...
OPV_DATA = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/preprocess/OPV_Min/Machine Learning OPV Parameters - device_params.csv",
)
...
class manual_frag:
    ...
    def create_manual_csv(self, frag_dict, master_manual_path):
        ...
        manual_df["DA_manual"] = ""
        manual_df["DA_manual_aug"] = ""
        manual_df["DA_manual_aug_str"] = ""
        ...
        for i in range(len(manual_df)):
            ...
            for aug_donors in augmented_donor_list:
                ...
                da_pair_frags_aug.append(da_aug_pair)

            # ADD TO MANUAL DF
            # print(type(da_pair_tokenized))
            manual_df.at[i, "DA_manual"] = da_pair_frags
            manual_df.at[i, "DA_manual_aug"] = da_pair_frags_aug
            # create string version of augmented polymers
            polymer_aug_str_list = []
            for polymer in da_pair_frags_aug:
            ...
            manual_df.at[i, "DA_manual_aug_str"] = polymer_aug_str_list
